    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate pb-0 text-center">
          <p class="breadcrumbs"><span class="mr-2"><a href="../index.php">Home <i class="fa fa-chevron-right"></i></a></span> <span>Agents <i class="fa fa-chevron-right"></i></span></p>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-3 ftco-animate">
          <div class="agent">
            <div class="img">
              <img src="../images/eli.jpeg" class="img-fluid">
              <div class="desc">
                <h3><a href="properties.php">Eli Kumedzro</a></h3>
                <p class="h-info"><span class="details">+233550000543</span></p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-3 ftco-animate">
          <div class="agent">
            <div class="img">
              <img src="../images/madoc.jpeg" class="img-fluid" alt="Colorlib Template">
            </div>
            <div class="desc">
              <h3><a href="properties.php">Madoc Quaye</a></h3>
              <p class="h-info"> <span class="details">+233207777333</span></p>
            </div>
          </div>
        </div>
        <div class="col-md-3 ftco-animate">
          <div class="agent">
            <div class="img">
              <img src="../images/naa.jpeg" class="img-fluid" alt="Colorlib Template">
            </div>
            <div class="desc">
              <h3><a href="properties.php">Naa Lamile Dove</a></h3>
              <p class="h-info"> <span class="details">+233509999074</span></p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-3 ftco-animate">
          <div class="agent">
            <div class="img">
              <img src="../images/diggs.jpeg" class="img-fluid" alt="Colorlib Template">
            </div>
            <div class="desc">
              <h3><a href="properties.php">Digney Yemofio</a></h3>
              <p class="h-info"><span class="details">+233558073764</span></p>
            </div>
          </div>
        </div>
