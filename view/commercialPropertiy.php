...
if (isset($_GET['location']) && isset($_GET['price'])) {
  ...
  $sql = "SELECT * FROM pictures WHERE Location = '$location' AND selectprice = '$price'";
  ...
  if ($row_count == 0) {
    ...
    $sqlAllProperties = "SELECT * FROM pictures WHERE Location = '$location'";
...
$sqlLocation = "SELECT DISTINCT Location from pictures";
$resultLocation = mysqli_query($db, $sqlLocation);

$sqlPrice = "SELECT DISTINCT selectprice from pictures"; // Make sure the column name is correct
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate pb-0 text-center">
          ...
          <h1 class="mb-3 bread"> Commercial Properties</h1>
        </div>
      </div>
    </div>
  </section>
                      ...
                      <div class="custom-input">
                        <select name="location" class="form-control">
                          ...
                          while ($rowLocation = mysqli_fetch_assoc($resultLocation)) {
                            ...
                            $locationOption = $rowLocation['Location'];
                    ...
                    <div class="select-wrap">
                      ...
                      <select name="price" class="form-control">
                        ...
                        while ($rowPrice = mysqli_fetch_assoc($resultPrice)) {
                            ...
                            $priceOption = $rowPrice['selectprice']; // Make sure this matches your database column name
  ...
  <section class="ftco-section goto-here">
    <div class="container">
      ...
      if ($hasFilter) {
        ...
        $sql = "SELECT * from pictures WHERE " . implode(" AND ", $conditions);
        // echo $sql ; 
      } else {
          ...
          <div class="col-md-4">
            <div class="item">
              <div class="property-wrap ftco-animate">
                <a href="singlecommercial.php?imageID=<?php echo $property['ImagesID']; ?>" class="img" style="background-image: url('../uploaded_photo/<?php echo $property['ImageName1']; ?>');">
                  <div class="rent-sale">
                ...
                <div class="text">
                  ...
                  <h3><a href="singlecommercial.php?imageID=<?php echo $property['ImagesID']; ?>"><?php echo $property['Enterprise']; ?></a></h3>
                  <span class="location"><?php echo $property['Location']; ?></span>
                  <a href="singlecommercial.php?imageID=<?php echo $property['ImagesID']; ?>" class="d-flex align-items-center justify-content-center btn-custom">
      ...
      $sql1 = "SELECT COUNT(*) as count FROM pictures";
