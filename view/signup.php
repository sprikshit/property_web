...
<script type="text/javascript">
        function valid(){
           ...
           /* if (! password_1.value.match(/^(?=.*[0-9]+.*)(?=.*[a-zA-Z]+.*)[0-9a-zA-Z]{6,}$/)){
...
<div class="header">
    ...
    <h3>PropertyDash</h3>
    <br>
    <h4>Signup To See Details of Properties</h4>
    </div>
    ...
    <div class="content flex">
      ...
      <?php include ('errors.php'); ?>
        ...
        <button name="Submit" id="Submit" class="login-btn">Signup</button>
        <button name="Cancel" id="Cancel" class="cancel-btn">Cancel</button>

      </form>
      <div class="bottom-container">
        <p>Already have an account?</p><a href="ind.php">LogIn!</a>
      <div>
