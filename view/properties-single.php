...
if (isset($_GET['imageID'])) {
  ...
  $query = "SELECT Enterprisee, Descriptionn, ImageName1, ImageName2, ImageName3,videoss, Statuss, Pricee, Locationn,  Contactt FROM picz WHERE ImagesID = $productID";
...
<body>
  ...
  <div class="container my-5">
    <?php if (isset($product)) : ?>
      <center>
        <h1><?php echo $product['Enterprisee']; ?></h1>
      </center>
      ...
      <div class="row">
        <div class="col-lg-6 sildercontent">
          ...
          <div id="productCarousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              ...
              // Display images
              $imagePaths = array(
                "../uploaded_photos/{$product['ImageName1']}",
                "../uploaded_photos/{$product['ImageName2']}",
                "../uploaded_photos/{$product['ImageName3']}"
              );
              ...
              // // Display video
              // if (!empty($product['Videoss'])) {
              //     echo '<div class="carousel-item">';
              //     echo '<video controls width="100%"><source src="./uploaded_video/' . $product['Videoss'] . '" type="video/mp4"></video>';
              //     echo '</div>';
              // }
              ?>
              <div class="carousel-item">
                <video controls width="100%">
                  <source src="../uploaded_video/<?php echo $product['videoss']; ?>" type="video/mp4">
        ...
        <div class="col-lg-6">
          <!-- Enquire button -->
          <p>Status: <?php echo $product['Statuss']; ?></p>
          <p><?php echo $product['Descriptionn']; ?></p>
          <p>Price: <?php echo $product['Pricee']; ?></p>
          <p>Locaton: <?php echo $product['Locationn']; ?></p>
          <p>Contact: <?php echo $product['Contactt']; ?></p>
