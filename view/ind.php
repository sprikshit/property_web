...
if(isset($_POST['Login'])){
  ...
  $db = mysqli_connect('localhost','root','','summer');
...
<div class="header">
  ...
  <h3>PropertyDash</h3>
  <br>
  <h4>Kindly Login To See Details of Properties</h4>
  </div>
  ...
  <div class="content flex">
    ...
    <?php include ('errors.php'); ?>
      ...
      <button name="Login" id="Login" class="login-btn">Login</button>
      <button name="Cancel" id="Cancel" class="cancel-btn">Cancel</button>

    </form>
    <div class="bottom-container">
      <p>Not registered with us?</p><a href="signup.php">Sign Up!</a>
    <div>
